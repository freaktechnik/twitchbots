...
$app->configureMode('development', function () use ($app) {
    ...
    $app->config(array(
        ...
        'csp' => "default-src 'none'; style-src 'self'; script-src 'self' https://humanoids.be; font-src 'self'; connect-src https://api.twitchbots.info https://api.twitch.tv; form-action 'self'; frame-ancestors 'none'; reflected-xss block; child-src https://humanoids.be",
...
$app->configureMode('production', function () use ($app) {
    ...
    $app->config(array(
        ...
        'csp' => "default-src 'none'; style-src 'self'; script-src 'self' https://humanoids.be; font-src 'self'; connect-src https://api.twitchbots.info https://api.twitch.tv; form-action 'self'; frame-ancestors 'none'; reflected-xss block; base-uri twitchbots.info www.twitchbots.info; referrer no-referrer-when-downgrade; child-src https://humanoids.be",
